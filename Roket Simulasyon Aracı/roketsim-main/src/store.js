...
const defaultParams = {
  windSpeed: 5,
  parts: [
    // Varsayılan küçük roket — Kendi değerlerini gir!
...
export const useSimStore = create((set) => ({
  ...
  initiateLaunch: async () => {
    ...
    try {
      ...
      // İsteğe bağlı uyarilar varsa loga bas
      ...
      set({
        running: false,
        phase: 'IDLE',
        logs: [{ id: 'err', time: 0, msg: 'SUNUCU ÇEVRİMDIŞI — Lütfen baslat_sunucu.bat ile sunucuyu açın.' }]
      });
    }
  }
}));
